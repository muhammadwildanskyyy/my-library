...
from app.api.v1.schemas.shelf import ShelfCreate, ShelfListResponse, ShelfResponse, ShelfUpdate
...
@router.patch(
    "/{shelf_id}",
    response_model=ShelfResponse,
    summary="Update a shelf's attributes",
)
async def update_shelf(
    ...
    try:
        shelf = await shelf_svc.update_shelf(
            shelf_id=shelf_id,
            user_id=user_id,
